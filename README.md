...
![Kitestring 应用界面预览](./docs/screenshot.svg)
...
首个公开版本优先提供 macOS 安装包。Windows 和 Linux 可先从源码构建，后续版本会补充更多平台的预构建产物。
...
- v0.1.0 以 macOS 预构建包为首发验证目标，Windows/Linux 需要从源码构建或等待后续发布。
...
![Kitestring app preview](./docs/screenshot.svg)
...
The first public release prioritizes macOS prebuilt artifacts. Windows and Linux users can build from source for now; broader prebuilt support will come later.
...
- v0.1.0 prioritizes macOS prebuilt artifacts; Windows/Linux can build from source.
